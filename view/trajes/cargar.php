            ...
            <div id="cuerpo"> 
                ...
                <div id="principal"> 
                    ...
                    <div id="contenedor">
                        <div id="lateral2">
                            <?php
                            $tra = unserialize($_SESSION['traje']);
                            ?>
                            <form action="../../controller/con_main.php" name="form">
                                <section class="datos">
                                    ...
                                    <input type="text" 
                                           value="<?php echo $tra->getCATEGORIA_TRA(); ?>"
                                           name="categoria"
                                    ...
                                    <input type="text" 
                                           value="<?php echo $tra->getDESCRIPCION_TRA(); ?>"
                                           name="descripcion"
                                           oninput="soloLetras(event);" 
                                    ...
                                    <input type="text" 
                                           name="numero" 
                                           value="<?php echo $tra->getNUM_PRENDAS_TRA(); ?>"
                                           ...
                                           /></br>
                                    <input type="hidden" value="actualizar_traje" name="opcion">
